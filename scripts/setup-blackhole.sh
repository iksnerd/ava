...
echo "  5. IMPORTANT: in the call itself, set the app's own audio output to that"
echo "     Multi-Output Device. Conferencing apps cache their output device at"
echo "     join time and ignore the macOS default changing afterwards — in Meet"
echo "     that is three-dot menu -> Settings -> Audio -> Speakers. Skipping this"
